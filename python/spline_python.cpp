...
bezier_t* wrapBezierConstructorBoundsConstraints(const point_list_t& array, const curve_constraints_t& constraints,
                                                 const real ub) {
  return wrapBezierConstructorConstraintsTemplate<bezier_t, point_list_t, t_point_t, curve_constraints_t>(
      array, constraints, ub);
}
/*END 3D constructors */
/*6D constructors */
...
bezier6_t* wrapBezierConstructor6Constraints(const point_list6_t& array, const curve_constraints6_t& constraints) {
  return wrapBezierConstructorConstraintsTemplate<bezier6_t, point_list6_t, t_point6_t, curve_constraints6_t>(
      array, constraints);
}
...
spline_deriv_constraint_t* wrapSplineDerivConstraint(const coeff_t& array, const time_waypoints_t& time_wp,
                                                     const curve_constraints_t& constraints) {
  t_waypoint_t wps = getWayPoints(array, time_wp);
  return new spline_deriv_constraint_t(wps.begin(), wps.end(), constraints);
}

spline_deriv_constraint_t* wrapSplineDerivConstraintNoConstraints(const coeff_t& array,
...
BOOST_PYTHON_MODULE(hpp_spline) {
  ...
  class_<bezier6_t>("bezier6", no_init)
  ...
  /** BEGIN bezier curve**/
  class_<bezier_t>("bezier", no_init)
  ...
  class_<exact_cubic_t>("exact_cubic", no_init)
  ...
  class_<spline_deriv_constraint_t>("spline_deriv_constraint", no_init)
